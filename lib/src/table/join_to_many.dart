...
class PgJoinToMany<TableType, JoinedTableType> {
  ...
  /// from JSON to a list of custom [PgModel]s of type [ModelType] for you.
  ///
  /// It also generates the fancy query pattern required to query the joined
  /// table.
  PgColumn<TableType, List<ModelType>, PgJsonList>
  call<ModelType extends PgModel<JoinedTableType>>(
    PgModelBuilder<JoinedTableType, ModelType> builder,
  ) => PgColumn<TableType, List<ModelType>, PgJsonList>.withQueryPattern(
