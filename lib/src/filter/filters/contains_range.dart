...
/// {@template typesafe_postgrest.PgContainsRangeFilter}
///
...
///
/// {@endtemplate}
class PgContainsRangeFilter<TableType, T extends Object>
    extends PgFilter<TableType> {
  /// {@macro typesafe_postgrest.PgContainsRangeFilter}
  @internal
  const PgContainsRangeFilter(
    this.column,
    this.lowerBound,
    this.upperBound,
    this.rangeType,
