...
/// {@template typesafe_postgrest.PgRangeLessOrEqualFilter}
///
...
///
/// {@endtemplate}
class PgRangeLessOrEqualFilter<TableType, T extends Object>
    extends PgFilter<TableType> {
  /// {@macro typesafe_postgrest.PgRangeLessOrEqualFilter}
  @internal
  const PgRangeLessOrEqualFilter(
    this.column,
    this.lowerBound,
    this.upperBound,
    this.rangeType,
